...
import com.weatherNotes.conf.security.SecurityConfig;
import com.weatherNotes.utils.LoggingAspect;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter {
    ...
    public MessageSource messageSource() {
        ...
        messageSource.setBasename(Defines.Statics.VALIDATION_MSG_FILE_NAME);
