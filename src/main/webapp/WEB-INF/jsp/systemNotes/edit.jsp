        ...
        <div class="fullwidth-block">
            <div class="container">
                ...
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <h6>${systemNote.date}</h6>
                    
                    <spring:url value='/systemNotes/edit' var="actionUrl" />
                    ...
                    <form:form id="sysNoteForm" name='sysNoteForm' cssClass="basic-form"
                        ...
                        <input type="hidden" name="date" value="${systemNote.date}"/>
                        <input type="hidden" name="id" value="${systemNote.id}"/>
                        <div class="row">
